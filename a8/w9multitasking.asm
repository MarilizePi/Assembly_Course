# Lab 8 CS10 w9multitasking.asm 
# This is an example of very simple multitasking on the MIPS CPU.
# 
...
# user mode, it cannot start the multitasking going, as it does not have
...
never:	 .asciiz "We should never get here\n"
	...
	.text
	.globl main
main:	la $a0, main1   # Send the base addresses of
